    ...
    [
      SettingsSection(
        ...
        [
          ...
          SettingField(
            'legalName',
            'Denominação legal',
            'Acácia Microcrédito, Sociedade Unipessoal, Lda.',
            required: true,
          ),
          SettingField(
            'nuit',
      ...
      SettingsSection(
        ...
        [
          ...
          SettingField('website', 'Website', 'https://acacia.example'),
          SettingField(
            'province',
            'Província',
            'Maputo Cidade',
          ...
          SettingField('city', 'Distrito / cidade', 'KaMpfumo', required: true),
          SettingField('neighborhood', 'Bairro', 'Polana Cimento A'),
          SettingField(
            'address',
            'Rua / avenida e número',
            'Av. 24 de Julho, n.º 1280',
            required: true,
          ),
          SettingField('postal', 'Código postal', '1100'),
        ],
      ),
      SettingsSection(
        'Dados bancários',
        ...
        [
          SettingField('bank', 'Banco', 'Banco Comercial e de Investimentos'),
          SettingField(
            'accountHolder',
            'Titular',
            'Acácia Microcrédito, SU, Lda.',
          ),
          SettingField('bankAccount', 'Número de conta', '12345678901'),
          SettingField('nib', 'NIB', '000100001234567890123'),
          SettingField('swift', 'SWIFT / BIC', 'CGDIMZMA'),
        ],
      ),
    ],
  ),
      ...
      SettingsSection(
        ...
        [
          ...
          SettingField(
            'documentHeader',
            'Cabeçalho',
            'Crédito responsável. Crescimento sustentável.',
          ),
          SettingField(
            'documentFooter',
            'Rodapé',
            'Acácia Microcrédito · Maputo · +258 84 123 4567',
          ),
        ],
      ),
      SettingsSection(
...
SettingsData defaultSettings() => {
  ...
  'branches': [
    {
      'code': 'MPT',
      'name': 'Sede Maputo',
      'address': 'Av. 24 de Julho, 1280 · Maputo',
      'phone': '+258 84 123 4567',
      'manager': 'Helena Matavele',
      'status': 'Activa',
    },
    {
      'code': 'MTL',
      'name': 'Agência Matola',
      'address': 'Av. das Indústrias, 45 · Matola',
      'phone': '+258 85 234 5678',
      'manager': 'Ernesto Macamo',
      'status': 'Activa',
    },
    {
      'code': 'BEI',
      'name': 'Agência Beira',
      'address': 'Av. Samora Machel, 92 · Beira',
      'phone': '+258 86 345 6789',
      'manager': 'Lídia Chissano',
      'status': 'Activa',
    },
  ],
  'users': [
    {
      'id': 'USR-001',
      'name': 'Helena Matavele',
      'email': 'helena@acacia.example',
      'phone': '+258 84 123 4567',
      'role': 'Gestor',
      'branch': 'MPT',
      'status': 'Activo',
      ...
      'history': 'Conta criada em 12/02/2024. Perfil Gestor atribuído.',
    },
    {
      'id': 'USR-002',
      'name': 'Ernesto Macamo',
      'email': 'ernesto@acacia.example',
      'phone': '+258 85 234 5678',
      'role': 'Operador',
      'branch': 'MTL',
      'status': 'Activo',
      ...
      'address': 'Matola A',
      'history': 'Conta criada em 03/05/2024. Agência Matola.',
    },
    {
      'id': 'USR-003',
      'name': 'Lídia Chissano',
      'email': 'lidia@acacia.example',
      'phone': '+258 86 345 6789',
      'role': 'Avalista',
      'branch': 'BEI',
      'status': 'Activo',
      'lastAccess': '19/09/2026 16:30',
      'address': 'Ponta Gêa, Beira',
      'history': 'Conta criada em 08/06/2025. Perfil Avalista atribuído.',
    },
    {
      'id': 'USR-004',
      'name': 'Carlos Nhantumbo',
      'email': 'carlos@acacia.example',
  ...
  'sequences': [
    for (final (name, prefix) in [
      ...
      {'document': name, 'prefix': prefix, 'next': '304'},
  ],
  'signers': [
